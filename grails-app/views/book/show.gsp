    ...
    <ol class="property-list book">
        ...
        <g:if test="${bookInstance?.ISBN}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="ISBN-label"><g:fieldValue bean="${bookInstance}"
                                                                                        field="ISBN"/></span>
        ...
        <g:if test="${bookInstance?.year}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="year-label"><g:fieldValue bean="${bookInstance}"
                                                                                        field="year"/></span>
