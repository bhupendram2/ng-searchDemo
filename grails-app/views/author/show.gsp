...
<div id="show-author" class="content scaffold-show" role="main">
    ...
    <ol class="property-list author">
        ...
        <g:if test="${authorInstance?.address}">
            <li class="fieldcontain">
                <span id="address-label" class="property-label"><g:message code="author.address.label"
                                                                           default="Address"/></span>

                <span class="property-value" aria-labelledby="address-label"><g:fieldValue bean="${authorInstance}"
                                                                                           field="address"/></span>
        ...
        <g:if test="${authorInstance?.book}">
            <li class="fieldcontain">
                ...
                <g:each in="${authorInstance.book}" var="b">
                    <span class="property-value" aria-labelledby="book-label"><g:link controller="book" action="show"
        ...
        <g:if test="${authorInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${authorInstance}"
                                                                                        field="name"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${authorInstance?.id}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
