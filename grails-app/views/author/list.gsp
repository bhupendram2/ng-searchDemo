...
<div id="list-author" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="address" title="${message(code: 'author.address.label', default: 'Address')}"/>
        ...
        <g:each in="${authorInstanceList}" status="i" var="authorInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${authorInstance.id}">${fieldValue(bean: authorInstance, field: "address")}</g:link></td>
