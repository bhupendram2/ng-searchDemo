    ...
    p.module("ngAnimate", ["ng"]).config(["$provide", "$animateProvider", function (R, L) {
        ...
        R.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement", "$timeout", "$rootScope", "$document", function (w, E, G, s, M, m, N) {
                    ...
                    if (Q(b, e) || 0 === z.length)u(), v(); else {
                        ...
                        B && (g.disabled || g.running && g.structural) || l(z, function (e) {
                            if (!e.allowCancel || e.allowCancel(b, a, d)) {
                                var f = e[a];
                                "leave" ==
                                    a ? (e = f, f = null) : e = e["before" + a.charAt(0).toUpperCase() + a.substr(1)];
                                t.push({before: e, after: f})
                            }
                        });
                        0 === t.length ? (u(), w()) : (e = " " + n + " ", g.running && (M.cancel(g.closeAnimationTimeout), D(b), I(g.animations), g.beforeComplete ? (g.done || q)(!0) : B && !g.structural && (e = "removeClass" == g.event ? e.replace(g.className, "") : e + g.className + " ")), n = " " + d + " ", "addClass" == a && 0 <= e.indexOf(n) || "removeClass" == a && -1 == e.indexOf(n) ? (u(), w()) : (b.addClass(C), b.data(h, {running: !0, event: a, className: d, structural: !B, animations: t, done: p}),
                            s(t, "before", p)))
                    }
                } else u(), v()
            }
            ...
            function Q(a, d) {
                ...
                do {
                    if (0 === d.length)break;
                    var b = f(d) == f(s), e = b ? k : d.data(h),
                        e = e && (!!e.disabled || !!e.running);
                    if (b || e)return e;
                    if (b)break
                } while (d = d.parent());
                return!0
            ...
            ["$window", "$sniffer", "$timeout", function (h, k, G) {
                ...
                function m(c, a) {
                    ...
                    if (!y) {
                        ...
                        y = {total: 0, transitionPropertyStyle: p, transitionDurationStyle: m, transitionDelayStyle: n, transitionDelay: d, transitionDuration: b, animationDelayStyle: k, animationDelay: g, animationDuration: f};
                        a && (H[a] = y)
                    }
                    return y
                }
                ...
                function r(c, a) {
                    ...
                    var k = "";
                    0 < d.transitionDuration ? f(c).style[e +
                        S] = "none" : f(c).style[x] = "none 0s";
                    l(a.split(" "), function (c, a) {
                        k += (0 < a ? " " : "") + c + "-active"
                    });
                    c.data(n, {className: a, activeClassName: k, maxDuration: b, maxDelay: h, classes: a + " " + k, timings: d, stagger: g, ii: $});
                    return!0
                }
                ...
                function D(c, a, d) {
                    ...
                    if (-1 != l.className.indexOf(a) && k) {
                        ...
                        if (0 < m.transitionDuration) {
                            ...
                            -1 == x.indexOf("all") && (A += b + "transition-property: " + x + ";",
                                A += b + "transition-duration: " + m.transitionDurationStyle + ";", q.push(b + "transition-property"), q.push(b + "transition-duration"))
                        }
                        ...
                        0 < q.length && (m = l.getAttribute("style") || "", l.setAttribute("style",
                            m + " " + A));
                        c.on(u, h);
                        c.addClass(r);
                ...
                var X = "Duration", S = "Property", Z = "Delay", u = "IterationCount", v = "$$ngAnimateKey",
                    n = "$$ngAnimateCSS3Data", z = 3, R = 1.5, B = 1E3, t = 0, H = {}, Y = 0, T = [], U = [], V, P = 0;
                return{allowCancel: function (a, b, e) {
